<?php ?>
<div class="wrap">
    <h2><?php esc_html_e('Kads SEO Plugin Options', 'kseo'); ?></h2>
            ...
            <div id="normal-sortables" class="meta-box-sortables ui-sortable kads-seo-postbox-warp clearfix">
                <form name="kads-seoconf" id="kads-seo-conf" action='<?php echo $urlpost ?>' method='post' >
                    <div id="referrers" class="postbox kads-seo-has-sidebar">
                        <h3 class="hndle"><span><?php esc_html_e('SEO Settings', 'kseo'); ?></span></h3>
                        <div class="inside">
                            ...
                            <div class="kads-seo-row kads-seo-row-sidebar-actions">
                                <input type="hidden" name="kseo_action" value="general_settings">
